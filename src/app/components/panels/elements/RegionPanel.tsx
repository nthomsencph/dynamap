...
export function RegionPanel({ region, onClose, onBack }: RegionPanelProps) {
            ...
            <li key={childData.region.id} className="container-item">
              ...
              >
                <span className="container-item-name">
                  {childData.region.name}
                </span>
                <span className="container-item-type">
                  {childData.region.type}
                </span>
              </button>
  ...
  return (
    <BasePanel element={region} onClose={onClose} onBack={onBack}>
