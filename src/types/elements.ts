...
import {
  FaDungeon as Fa6Dungeon,
  FaCrown as Fa6Crown,
  FaMountain as Fa6Mountain,
  FaPlaceOfWorship as Fa6PlaceOfWorship,
  FaSailboat,
  FaDroplet,
...
export const ELEMENT_ICONS = {
  ...
  PiCastleTurretDuotone: {
    label: 'Castle Turret Duotone',
    icon: PiCastleTurretDuotone,
  },
  PiCastleTurretFill: { label: 'Castle Turret Fill', icon: PiCastleTurretFill },
  PiCastleTurretLight: {
    label: 'Castle Turret Light',
  ...
  Fa6PlaceOfWorship: {
    label: 'Place of Worship (Alt)',
    icon: Fa6PlaceOfWorship,
  },
