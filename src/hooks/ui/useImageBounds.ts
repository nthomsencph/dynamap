...
import { calculateImageBounds, type ImageBounds } from '@/app/utils/image-bounds';
 ...
 */
export function useImageBounds(imageUrl: string | null, mapImageSettings: MapImageSettings) {
